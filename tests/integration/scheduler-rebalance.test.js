...
describe('Scheduler rebalancing', () => {
  ...
  test('triggers board transfer between workers with CPU-only deep zoom', async () => {
    ...
    // 25 views at z=1e14 with CPU only - triggers transfer in ~16 seconds
    const params = 'z=1e14&a=16:9&gpu=0&c=-0.5425060105393306400515387573956+0.5082791199098461776529578942116i,,,,,,,,,,,,,,,,,,,,,,,,&grid=25&unk=888&pixelratio=1';
