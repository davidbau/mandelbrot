  ...
  (() => {
    ...
    var mvhd = (creationTime, tracks) => {
      ...
      return fullBox("mvhd", +needsU64, 0, [
        ...
        Array(10).fill(0),
        // Reserved
        [fixed_16_16(1), fixed_16_16(0), fixed_2_30(0), fixed_16_16(0), fixed_16_16(1), fixed_2_30(0), fixed_16_16(0), fixed_16_16(0), fixed_2_30(1)],
        // Matrix
        Array(24).fill(0),
        // Pre-defined
        u32(nextTrackId)
    ...
    var _options, _writer, _ftypSize, _mdat, _videoTrack, _creationTime, _finalizedChunks, _finalized, _validateOptions, validateOptions_fn, _writeHeader, writeHeader_fn, _prepareTracks, prepareTracks_fn, _createSampleForTrack, createSampleForTrack_fn, _addSampleToTrack, addSampleToTrack_fn, _validateTimestamp, validateTimestamp_fn, _finalizeCurrentChunk, finalizeCurrentChunk_fn, _maybeFlushStreamingTargetWriter, maybeFlushStreamingTargetWriter_fn, _ensureNotFinalized, ensureNotFinalized_fn;
    var Muxer = class {
      constructor(options) {
